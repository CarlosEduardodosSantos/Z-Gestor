...
namespace ZapFood.WinForm.Componente.PopupNotifier
{
    /// <summary>
    ...
    internal class PopupNotifierForm : System.Windows.Forms.Form
    {
        ...
        public PopupNotifierForm(ZapFood.WinForm.Componente.PopupNotifier.PopupNotifier parent)
        {
            Parent = parent;
        ...
        /// </summary>
        public new ZapFood.WinForm.Componente.PopupNotifier.PopupNotifier Parent { get; set; }
