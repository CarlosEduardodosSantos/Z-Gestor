...
namespace ZapFood.WinForm.ProdutoWinzard
{
    public partial class ProdutoWinzardFrmParent : Form
    {
        FormBase[] frm = { new frm1(), new frm2(), new frm3(), new form5(), new frm4() };
        int top = -1;
        int count;

        public ProdutoWinzardFrmParent()
        {
            count = frm.Count();
            InitializeComponent();
        }
